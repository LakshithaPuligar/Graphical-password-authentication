...
<body>
    ...
    <form id="imageSelectionForm" action="verify-gridt2.php" method="POST">
        ...
        <input type="hidden" name="selectedGridCells" id="selectedGridCells" required>
    ...
    <script>
        let selectedCells = []; // Store selected grid cell indexes
        ...
        function createGrid(imageSrc) {
            ...
            selectedCells = []; // Reset selected grid parts
        ...
        function toggleGridSelection(gridItem) {
            ...
            document.getElementById("selectedGridCells").value = selectedCells.join(",");
        }
    </script>
</body>
</html>
